# app.py - Streamlit Deployment UI for Client 25
import streamlit as st
import os
from PIL import Image
from predict import predict_single_image

st.set_page_config(page_title="Height Detector Portal 25", page_icon="🎯")
st.title("🎯 Space Tracker Console — Version 25")
st.sidebar.info("Backbone: MobileNetV2_Light\nTheme Style: Red")
